  ...
  problems: [
    {
      ...
      anomaly:
        "传统焊锡工艺在撤走焊头时，极易产生锋利的残留「锡尖（拉尖）」。在后续线束装配弯折或整车高频振动工况下，坚硬的锡尖会物理穿透内层绝缘皮，直接引发致命的高压短路与起火隐患。",
      solution:
        "工艺路线重构：全面淘汰传统屏蔽网焊锡工艺，迭代为「高精冷压接 + 双壁带胶热缩管」的无损物理锁固方案。从根源上彻底消除热应力损伤与拉尖穿刺风险，实现电气性能与机械抗拉强度的双重跃升。",
    },
    {
      id: 2,
      title: "手工处理致屏蔽网大面积挑伤",
      ...
      imgSrc: null as string | null,
      anomaly:
        "依赖传统纯手工挑解屏蔽网时，员工作业力度与角度难以标准化，极易导致底层屏蔽丝断裂、散乱或局部遗漏，严重削弱线束的 EMC 电磁屏蔽效能。",
      solution:
        "全线淘汰手工挑网，引入全自动高精度「扫屏蔽设备」。实现 360° 柔性均匀翻折与梳理，杜绝一切人工机械干预，确保屏蔽网完整率 100%。",
    },
  ],
  sops: [
    {
      id: 1,
      processName: "屏蔽网压接与热缩防护工序",
      oldProcess: {
        imgLabel: "原工艺现场记录",
        imgSrc: null as string | null,
        desc: "原工艺采用高温焊锡处理屏蔽层，作业指导书仅规定了大致焊接时间，缺乏对「撤锡轨迹」的微观量化管控，高度依赖老员工手感，极易产生致命锡尖。",
      },
      newSop: {
        imgLabel: "更新后标准 SOP (作业指导书)",
        imgSrc: null as string | null,
        desc: "SOP 彻底重构：全面废除焊锡。写入绝对标准：必须使用专用冷压设备进行屏蔽环压接，并强制热缩双壁带胶套管。明确压接后尺寸公差及热缩后的拉拔力最低阈值。",
      },
    },
    {
      id: 2,
      processName: "屏蔽网全自动打散与梳理工序",
      oldProcess: {
        imgLabel: "旧机台参数设定画面",
        imgSrc: null as string | null,
        desc: "原工艺采用手工锥子挑解屏蔽网，作业指导书无法量化挑解力度与角度，导致内部绝缘层微观划伤及屏蔽丝挑断隐患处于盲盒状态，一致性极差。",
      },
      newSop: {
        imgLabel: "更新后标准 SOP (作业指导书)",
        imgSrc: null as string | null,
        desc: "SOP 全新升级：规定必须使用高精度「扫屏蔽机器」。明确机器参数规范：设定精确的旋转转速与柔性梳理进刀行程。引入工序首件 360° 环视显微检验，确保屏蔽丝完整率 100%。",
      },
    },
  ],
  metrics: [
